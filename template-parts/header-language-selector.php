...
<form id="language-form" class="lang">
    <label class="cursor--click anim lang__item <?php echo ($language == 'pl') ? 'active' : ''; ?>" tabindex="0">
        <input type="radio" name="language" value="pl" <?php checked($language, 'pl'); ?>>
        <span>
            <?php _e('PL', 'textdomain'); ?>
        </span>
    </label>
    <label class="cursor--click anim lang__item <?php echo ($language == 'fr') ? 'active' : ''; ?>" tabindex="0">
        <input type="radio" name="language" value="fr" <?php checked($language, 'fr'); ?>>
        <span>
            <?php _e('FR', 'textdomain'); ?>
        </span>
    </label>
    <label class="cursor--click anim lang__item <?php echo ($language == 'en') ? 'active' : ''; ?>" tabindex="0">
